...
for baris in range(0, m1-1): # Membaca baris pada matrix gambar1
    for kolom in range(0, n1-1): # Membaca kolom pada matrix gambar1
        ...
        # Perhitungan jumlah piksel sekitar pada citra yang disimpan dalam variabel jumlah
        ...
        output1[a1, b1] = (1/9 * jumlah) # Perhitungan rata-rata dengan mengalikan jumlah piksel dengan skalar 1/9 (1 dibagi 9)

for baris1 in range(0, m2-1): # Membaca baris pada matrix gambar2
    for kolom1 in range(0, n2-1): # Membaca kolom pada matrix gambar2
        a1 = baris1 # Mendklarasikan variable baris gambar2
        b1 = kolom1 # Mendklarasikan variable kolom gambar2
        # Perhitungan jumlah piksel sekitar pada citra yang disimpan dalam variabel jumlah
        ...
        output2[a1, b1] = (1/9 * jumlah) # Perhitungan rata-rata dengan mengalikan jumlah piksel dengan skalar 1/9 (1 dibagi 9)
